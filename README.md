...
7. Удалите документ, проверьте корзину и восстановление. Удалённый документ не участвует в новых ответах и консультациях. Документ из корзины можно удалить навсегда: введите его название, и вместе с ним удалятся оригинал, все версии, факты, фрагменты поиска и консультации, собранные из него. Резервные копии это не затрагивает.
