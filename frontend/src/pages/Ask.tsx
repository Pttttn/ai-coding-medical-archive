...
const prompts = ['Какие обследования есть в архиве?', 'Что рекомендовали на последнем приёме?', 'Как менялись показатели анализов?'];
export function AskPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    try { setAnswer(await api<AskAnswer>('/ask', { method: 'POST', body: json({ question: question.trim() }) })); }
