...
- [ ] Ответ автора на открытые вопросы: runtime и машина для Qwen 3.8 27B, мультимодальная сборка или отдельная vision-модель, роль веб-кабинета, папка входящих.
- [ ] A0: закрыть предусловия безопасности из ревью 25.09 и P0–P2 pipeline.
- [ ] A1: измерить Qwen 3.8 27B с контекстом 180k на целевой машине: latency, память, стабильность.
