...
- [ ] P3: facts/provenance/chunks из одной IR; staging/activation, crash/retry/reprocess, UI качества/источника. Staging/activation и retry сделаны в [срезе P3](#срез-p3-processing-revision-и-активация-26-сентября-2026); остаются выбор режима reprocess, подтверждение настроек индекса и UI качества.
...
- [ ] P0: независимый held-out corpus для baseline; P3: подтверждение настроек индекса индексатором; выбор режима reprocess в UI (`processing_revisions`, активация и staging индекса сделаны в срезе P3 ниже).
...
- [ ] Выбор режима reprocess («текущий текст» или «заново разобрать оригинал»); подтверждение настроек индекса индексатором; сохранение прежнего снимка при правке текста пользователем; UI качества/источника.
