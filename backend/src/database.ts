...
export function createDataSource(url=process.env.DATABASE_URL) {
  ...
  return new DataSource({type:'postgres',url,entities:ENTITIES,migrations:[Initial1750000000000,SourceIR1751000000000,ConsultationHistory1752000000000,ProcessingStages1753000000000],migrationsRun:true,synchronize:false,logging:false,extra:{max:10}});
}
